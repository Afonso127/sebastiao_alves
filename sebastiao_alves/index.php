...
<head>
    ...
    <body>
      ...
      <main class="container-fluid p-0">
        ...
        <div class="row topbemvindo">

          <div class="bemvindo ">
            
            <?php foreach($home as $h): ?>

              <img src="<?= $h["imagem_autor"]; ?>" alt="fotoeditor">
            <?php endforeach; ?>

              <div class ="legendasbv">

                <div class="titulobvsite">
                  BEM VINDO AO MEU WEBSITE
                </div>
              
                <?php foreach($autor as $a): ?>

                  <div class="textobvsite "> <?= $a["texto_autor"]; ?>  </div>
                <?php endforeach; ?>

                <div id= "betbv" >
                  <a href="autor.php">
                    <button class="sm float-end">SABER MAIS</button>
                  </a>
                </div>
              </div>
        ...
        <?php foreach($home as $h): ?>
          ...
          <div id= "legendashome" class="row">

            <div class="tithome col-12">ÚLTIMOS LIVROS</div>
            <div class="textohome col-12"><?=$h["texto"]; ?></div>

          </div>
        <?php endforeach; ?>

      
        <div id= "destaques" class="row mx-0">
        
          <?php foreach($destaques as $d): ?>
            
              <div class="card">
                <img src="<?=$d["img"]?>" class="card-img-top" alt="livro1">
                <div class="card-body">
                  <h5 class="card-title"><?=$d["titulo"]?></h5>
                  <h5 class="card-subtitle"><?=$d["observacao"]?></h5>
                  <p class="card-text"> <?=$d["texto"]?>
                  <div class="bvsabermais">
                    <a href="<?=$d["link"]?>">
                      <button class="sm">SABER MAIS</button>
                    </a>
                  </div>
