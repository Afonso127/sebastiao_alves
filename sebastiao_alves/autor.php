...
<head>
    ...
    <main class="container-fluid p-0">
        ...
        <div class="container descri mt-4">
          <?php foreach($autor as $a): ?>
            <div class="row">
              <div class="col-12 text-center mb-4">
                <img class="autimg" src="<?= $a["imagem_autor"] ?>" alt="imgautor">
              </div>
            </div>

            <div class="row descrite1 text-md-start text-center">
                <div class="col-12 descrite text-start"> 
                  <div class="d-none d-md-block" id="texto_grande"><?= $a["texto_autor"] ?></div>
                  <div class="d-block d-md-none" id="texto_pequeno"><?= substr($a["texto_autor"], 0, 2000) . "..." ?></div>
                ...
                <div class="row d-block d-md-none">
                  <a href="#">
                    <img class="voltaratras" src="imagens/vermais.svg" id="botao_vermais" onclick="verMaisAutor(event)" alt="Ver mais">
                  </a>
                </div>

                <div class="row">
                  <a href="#" onclick="voltarAtras()">
                    <img class="voltaratras" src="imagens/voltar1.svg" alt="Voltar">
                  </a>
                </div>
            </div>
          <?php endforeach; ?>
