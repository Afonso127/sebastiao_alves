    ...
    <main class="container-fluid p-0">
        ...
        <div id = "caixa_branca" class="row topbemvindo">
          ...
          <div id = "espbv">
            ...
            <div class="row">
              ...
              <div class="autor">CONTACTOS</div>
              <br>
              <div id="espsobre" class="sobre col-10 col-md-12">PODE CONTACTAR-ME ATRAVÉS DO E-MAIL E DO TELEFONE</div>
            </div>
        ...
        <div class="container contactos">
          <?php foreach($contacto as $c): ?>
            <div class="contactos1 row d-flex justify-content-md-center">
                <div class="col-md-2 mt-5 mt-md-none text-center">
                    <div class="contactos-titulo">TELEFONE</div>
                          
                    <div class="contactos-conteudo mt-2"><?=$c["telefone"]; ?></div>
                </div>
                <div class="col-md-3 mt-5 mt-md-none text-center">
               ...
               <div class="row">
                    <div id = "linhacont" class="col-12 linhabase mx-auto"></div>
               </div>

               <div class="row horario d-flex justify-content-center">

                    <div class="col-md-4 text-center">
                        <div class="contactos-titulo ">HORÁRIO</div>
                            
                        <div class="contactos-conteudo  mt-2"><?=$c["horario"]; ?> </div>
                    </div>
    ...
    <footer class="container" style="margin-top: 50px; margin-bottom: 70px;">
          ...
          <div class="row">
            ...
            <?php foreach($contacto as $c): ?>
              ...
              <div class="conta col-10 col-md-6 mx-auto">
              ...
              <div class=" col-12 col-md-5 destaques-titulo">
                <div class="redes">SIGA-ME NAS REDES SOCIAIS</div>

                <div class="mt-4 d-flex justify-content-center gap-4 gap-md-3 " >
